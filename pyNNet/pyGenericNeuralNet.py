'''
Some sources:
- https://nx.github.io/documentation/stable/reference/algorithms/operators.html
'''
...
class GenericNeuralNet(DiGraph):
    ...
    def __init__(self, topology = []):
        ...
        super(GenericNeuralNet, self).__init__()

        self._id = GenericNeuralNet._id
        GenericNeuralNet._id += 1
...
if __name__ == '__main__':
    ...
    topology = [1, 3, 2]
    network = GenericNeuralNet(topology)
    connectionDict = {
